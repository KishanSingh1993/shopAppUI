package `in`.eduforyou.shopapp.screen
...
import `in`.eduforyou.shopapp.model.Product
import `in`.eduforyou.shopapp.screen.component.ProductItem
import `in`.eduforyou.shopapp.R
